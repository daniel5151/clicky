// originally written by DaveChapman on Aug 1st 2007
// retrieved from https://www.rockbox.org/wiki/IpodFlash
//
// updated by Daniel Prilik to compile on newer gcc versions
